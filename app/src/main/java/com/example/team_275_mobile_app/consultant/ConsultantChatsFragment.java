...
public class ConsultantChatsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_consultant_chats, container, false);
        //setting toolbar tittle for this fragment, and first you have to make the toolbar public
        ((ConsultantMainActivity) getActivity()).toolbar.setTitle("Chats");
